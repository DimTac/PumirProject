$(document).ready(function(){
   $('#canvas').rouetourne({
     ...
     restoArraySrc : ['img/asiatique.png','img/salade.png','img/fastfood.png','img/brasserie.png','img/pizza.png','img/indien.png','img/crepe.png','img/sandwich.png','img/poisson.png','img/viande.png'],
