	    	...
	    	json = get_json_mot_clef(mot_clef, data);
	          ...
	          chaine += '<div class="modal-content">';
	            chaine += '<div class="modal-header" style="background-color:#be4c46;color:white;">';
	              ...
	              chaine += '<button type="button" id="fermer_modale" class="btn btn-default" data-dismiss="modal" style="width:200px; margin:0px auto 0px auto;">Retour à l\'accueil</button>';
	            chaine += '</div>';
